...
void saveNavData(const navdata_unpacked_t* const navdata)
{
    ...
    /**
     * Vision detect for special shapes (roundels, tags...)
     */
    globalNavData.vd_nb_detected = navdata->navdata_vision_detect.nb_detected;
    globalNavData.vd_xc = navdata->navdata_vision_detect.xc;
    globalNavData.vd_yc = navdata->navdata_vision_detect.yc;
